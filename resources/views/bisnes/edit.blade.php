            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Kemaskini Bisnes</h5>
                    </div>
                        ...
                        <form method="POST" action="{{ route('bisnes.update', $bisnes) }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_bines') is-invalid @enderror"
                                    id="nama_bines" name="nama_bines" value="{{ old('nama_bines', $bisnes->nama_bines) }}"
                                    required>
                                @error('nama_bines')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('jenis_bisnes') is-invalid @enderror"
                                    id="jenis_bisnes" name="jenis_bisnes"
                                    value="{{ old('jenis_bisnes', $bisnes->jenis_bisnes) }}" required>
                                @error('jenis_bisnes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('exp_date') is-invalid @enderror"
                                    id="exp_date" name="exp_date" value="{{ old('exp_date', $bisnes->exp_date) }}"
                                    required>
                                @error('exp_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" rows="3"
                                    required>{{ old('alamat', $bisnes->alamat) }}</textarea>
                                @error('alamat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('poskod') is-invalid @enderror"
                                    id="poskod" name="poskod" value="{{ old('poskod', $bisnes->poskod) }}" required>
                                @error('poskod')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control @error('no_tel') is-invalid @enderror"
                                    id="no_tel" name="no_tel" value="{{ old('no_tel', $bisnes->no_tel) }}" required>
                                @error('no_tel')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="gambar" class="form-label">Gambar Baru (Optional)</label>
