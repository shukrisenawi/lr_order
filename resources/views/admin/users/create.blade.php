            ...
            <div class="mt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="bisnes_ids[]" value="{{ $bisne->id }}" id="bisnes_{{ $bisne->id }}" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
