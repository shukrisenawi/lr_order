                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    <div>
                        <h1 class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-3">
                            <i class="fas fa-plus-circle text-blue-500 mr-4"></i>
                            Cipta Iklan Baru
                        </h1>
                        <p class="text-gray-600 text-lg">Tambah iklan baru dengan teknologi AI terkini</p>
                        <div class="flex items-center gap-4 mt-6">
                            ...
                            <div class="inline-flex items-center px-5 py-3 rounded-full text-sm font-semibold bg-gradient-to-r from-purple-100 to-pink-100 text-purple-800 border-2 border-purple-200 shadow-sm">
                ...
                <div class="px-8 py-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 via-white to-gray-50">
                    <div class="flex items-center">
                        ...
                        <div class="ml-6">
                            ...
                            <p class="text-gray-600 text-lg mt-1">Sila lengkapkan semua maklumat yang diperlukan untuk iklan baru</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <div class="relative">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" step="1" min="1" name="hari" value="{{ old('hari', $latestDay + 1) }}"
                            ...
                            <div class="relative">
                                ...
                                <div class="relative">
                                    <textarea name="keterangan" id="info_textarea_create" required
                                        ...
                                        rows="6" placeholder="Jelaskan kandungan iklan anda...">{{ old('keterangan') }}</textarea>
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-3xl p-8 border-2 border-blue-200 shadow-lg">
                                <div class="flex items-center mb-6">
                                    ...
                                    <h4 class="ml-4 text-lg font-bold text-gray-900">Petua Iklan Pintar</h4>
                                </div>

                                <div class="space-y-4">
                                    <div class="flex items-start p-4 bg-white/60 rounded-2xl border border-blue-100">
                                        <div class="flex-shrink-0 w-6 h-6 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full flex items-center justify-center mt-1 shadow-sm">
                                            <i class="fas fa-check text-white text-xs"></i>
                                        </div>
                                        <div class="ml-4">
                                            <p class="text-sm font-semibold text-gray-800">Nama yang Menarik</p>
                                            <p class="text-xs text-gray-600 mt-1">Gunakan nama yang mudah diingati dan berkesan</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start p-4 bg-white/60 rounded-2xl border border-blue-100">
                                        <div class="flex-shrink-0 w-6 h-6 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center mt-1 shadow-sm">
                                            <i class="fas fa-check text-white text-xs"></i>
                                        </div>
                                        <div class="ml-4">
                                            <p class="text-sm font-semibold text-gray-800">Faedah Produk</p>
                                            <p class="text-xs text-gray-600 mt-1">Jelaskan faedah dan nilai produk dengan jelas</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start p-4 bg-white/60 rounded-2xl border border-blue-100">
                                        <div class="flex-shrink-0 w-6 h-6 bg-gradient-to-r from-purple-500 to-pink-600 rounded-full flex items-center justify-center mt-1 shadow-sm">
                                            <i class="fas fa-check text-white text-xs"></i>
                                        </div>
                                        <div class="ml-4">
                                            <p class="text-sm font-semibold text-gray-800">AI Automation</p>
                                            <p class="text-xs text-gray-600 mt-1">Aktifkan AI untuk pengurusan automatik dan optimum</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
