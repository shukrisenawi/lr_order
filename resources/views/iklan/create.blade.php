...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <form method="POST" action="{{ route('iklan.store') }}" class="p-6">
                @csrf
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0" name="hari" value="{{ old('hari', $latestDay + 1) }}"
                ...
                <div class="mt-6">
                    ...
                    <div class="relative">
                        <textarea name="keterangan" id="info_textarea_create" required
                            ...
                            rows="100">{{ old('keterangan') }}</textarea>
