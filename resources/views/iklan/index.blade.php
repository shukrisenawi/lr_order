...
@section('content')
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Iklan Management</h1>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($iklan as $item)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-900">{{ Str::limit($item->description ?? 'N/A', 50) }}
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <a href="{{ route('iklan.show', $item) }}" class="text-blue-600 hover:text-blue-900">
                                    ...
                                    <form method="POST" action="{{ route('iklan.destroy', $item) }}" class="inline"
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <a href="{{ route('iklan.create') }}" class="text-blue-600 hover:text-blue-800 mt-2">
