    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <form method="POST" action="{{ route('produk.update', $produk) }}" class="p-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" name="harga"
                                    value="{{ old('harga', $produk->harga) }}" required placeholder="0.00"
                ...
                <div class="mt-6">
                    <label class="block text-sm font-semibold text-gray-800 mb-2">Info Produk<span
                            class="text-red-500">*</span></label>
                    <div class="relative">
                        <textarea name="info" id="info_textarea_create" required
                            ...
                            rows="100">{{ old('info', $produk->info) }}</textarea>
