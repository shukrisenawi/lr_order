            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl">
                            @if ($prospekBuy->produk)
                                ...
                                <p class="text-gray-600 text-sm">
                                    {{ $prospekBuy->produk->description ?? 'Tiada keterangan' }}</p>
                            @else
                    ...
                    <div>
                        ...
                        <div class="px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl">
                            <p class="text-gray-900">{{ $prospekBuy->kuantiti ?? 1 }}</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl">
                            <p class="text-gray-900">RM {{ number_format($prospekBuy->harga ?? 0, 2) }}</p>
                        </div>
                    </div>
                    ...
                    @if ($prospekBuy->notes)
                        <div class="md:col-span-2">
                            ...
                            <div class="px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl">
                                <p class="text-gray-900">{{ $prospekBuy->notes }}</p>
                            </div>
                        </div>
                    @endif
            ...
            <div class="p-6">
                <div class="bg-gradient-to-br from-rose-50 to-pink-50 border border-rose-200 rounded-xl p-6">
                    <div class="flex justify-between items-center mb-4 pb-4 border-b border-rose-100">
                        ...
                        <span class="font-medium text-rose-900">{{ $prospekBuy->produk->name ?? 'N/A' }}</span>
                    </div>
                    <div class="flex justify-between items-center mb-4 pb-4 border-b border-rose-100">
                        <span class="text-rose-900 font-medium">Kuantiti:</span>
                        <span class="font-medium text-rose-900">{{ $prospekBuy->kuantiti ?? 1 }}</span>
                    </div>
                    <div class="flex justify-between items-center mb-4 pb-4 border-b border-rose-100">
                        <span class="text-rose-900 font-medium">Harga Seunit:</span>
                        <span class="font-medium text-rose-900">RM {{ number_format($prospekBuy->harga ?? 0, 2) }}</span>
                    </div>
