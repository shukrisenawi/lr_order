    ...
    <div class="mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex gap-2">
                <a href="{{ route('ai') }}"
                    class="inline-flex items-center justify-center px-3 py-1.5 bg-purple-100 hover:bg-purple-200 text-purple-700 font-medium rounded-lg transition-colors duration-200">
                    <i class="fas fa-robot mr-1"></i>
                    AI Approval
                </a>
                <a href="{{ route('invoice.create') }}"
                    class="inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium rounded-lg shadow-md hover:from-blue-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
    ...
    <div class="mb-6 flex flex-col md:flex-row gap-4">
        ...
        <div class="relative">
            <select wire:model.live="statusFilter"
                class="px-4 py-2 border border-gray-200 rounded-lg bg-white focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-100 focus:outline-none transition-all duration-300 shadow-sm">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex space-x-1">
                                    ...
                                    <a href="{{ route('invoice.edit', $invoice) }}"
                                        class="inline-flex items-center px-2 py-1 text-sm font-medium text-orange-700 bg-orange-50 rounded hover:bg-orange-100 transition-colors duration-200">
                                        <i class="fas fa-edit mr-1"></i>
                                        Edit
                                    </a>
                                    <a href="{{ route('invoice.pdf', $invoice) }}"
                                        class="inline-flex items-center px-2 py-1 text-sm font-medium text-green-700 bg-green-50 rounded hover:bg-green-100 transition-colors duration-200">
