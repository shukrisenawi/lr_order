                ...
                <div class="flex flex-col md:flex-row items-center justify-between">
                    <div class="mb-4 md:mb-0">
                        ...
                        <p class="text-gray-600 text-sm md:text-base">
                            {{ now()->format('l, F j, Y') }} • Dashboard for
                            {{ $selectedBisnes ? $selectedBisnes->nama_bisnes : 'Selected Business' }}
                        </p>
                    </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
                    <a href="{{ route('bisnes.create') }}"
                        ...
                        <div class="flex flex-col items-center text-center relative z-10">
                            <i
                                class="fas fa-plus text-lg md:text-xl mb-2 group-hover:animate-bounce transition-transform duration-300"></i>
                    ...
                    <a href="{{ route('produk.create') }}"
                        ...
                        <div class="flex flex-col items-center text-center relative z-10">
                            <i
                                class="fas fa-box text-lg md:text-xl mb-2 group-hover:animate-bounce transition-transform duration-300"></i>
                    ...
                    <a href="{{ route('customer.create') }}"
                        ...
                        <div class="flex flex-col items-center text-center relative z-10">
                            <i
                                class="fas fa-users text-lg md:text-xl mb-2 group-hover:animate-bounce transition-transform duration-300"></i>
                    ...
                    <a href="{{ route('invoice.create') }}"
                        ...
                        <div class="flex flex-col items-center text-center relative z-10">
                            <i
                                class="fas fa-file-invoice text-lg md:text-xl mb-2 group-hover:animate-bounce transition-transform duration-300"></i>
