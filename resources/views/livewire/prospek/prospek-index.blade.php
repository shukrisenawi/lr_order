<div class="w-full px-2 sm:px-4 lg:px-6 py-4 min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 via-purple-50 to-pink-50">
    ...
    <div class="mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Pengurusan Prospek</h1>
                <p class="text-sm text-gray-600">Urus prospek dan pelanggan anda</p>
            ...
            <table class="w-full">
                <thead class="bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-sm font-semibold text-gray-700">On Ai</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($prospek as $item)
                        <tr class="hover:bg-amber-50 transition-colors duration-200"
                            ...
                            <td class="px-4 py-3 text-sm font-medium text-gray-900">{{ $item->no_tel }}</td>
                            <td class="px-4 py-3 text-sm text-gray-600">{{ $item->gelaran ?? '-' }}</td>
                            <td class="px-4 py-3 text-sm text-gray-600">{{ $item->session_id ?? '-' }}</td>
                        ...
                        <tr>
                            <td colspan="5" class="px-4 py-8 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <h3 class="text-base font-medium text-gray-900 mb-1">Tiada prospek dijumpai</h3>
                                    <p class="text-sm text-gray-500 mb-2">Cuba tukar carian anda atau tambah prospek baru</p>
                                    <a href="{{ route('prospek.create') }}"
