<div class="w-full px-2 sm:px-4 lg:px-6 py-4 min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 via-purple-50 to-pink-50">
    ...
    <div class="mb-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Pengurusan Pelanggan</h1>
                <p class="text-sm text-gray-600">Urus customer anda</p>
            </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse($customer as $item)
                        <tr class="hover:bg-amber-50 transition-colors duration-200"
                            ...
                            <td class="px-4 py-3 text-sm font-medium text-gray-600">{{ $item->nama_penerima }}</td>
                        ...
                        <tr>
                            <td colspan="5" class="px-4 py-8 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <h3 class="text-base font-medium text-gray-900 mb-1">No prospects found</h3>
                                    <p class="text-sm text-gray-500 mb-2">Try changing your search or add a new prospect</p>
                                    <a href="{{ route('customer.create') }}"
