<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
                <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-2">
                    {{ $isEdit ? 'Edit Jadual Pengajian' : 'Tambah Jadual Pengajian Baru' }}
                </h1>
                <p class="text-gray-600">
                    {{ $isEdit ? 'Kemaskini maklumat jadual pengajian masjid' : 'Cipta jadual pengajian masjid baru' }}
                </p>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
            <h3 class="text-xl font-semibold text-gray-900">Maklumat Jadual Pengajian</h3>
            <p class="text-gray-600 text-sm mt-1">
                {{ $isEdit ? 'Kemaskini maklumat jadual pengajian masjid di bawah' : 'Sila isi semua maklumat jadual pengajian yang diperlukan' }}
            </p>
        </div>
        ...
        <form wire:submit.prevent="save" class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="penceramah_program" placeholder="Contoh: Ustaz Aminudin Bin Abdul Rahman"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-300 @error('penceramah_program') border-red-500 bg-red-50 @enderror">
                        @error('penceramah_program')
                            <p class="mt-2 text-sm text-red-600 flex items-center">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                                {{ $message }}
                            </p>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="topik_kitab" placeholder="Contoh: Tafsir Juz Amma"
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all duration-300 @error('topik_kitab') border-red-500 bg-red-50 @enderror">
                        @error('topik_kitab')
                            <p class="mt-2 text-sm text-red-600 flex items-center">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                                {{ $message }}
            ...
            <div class="mt-10 flex flex-col sm:flex-row justify-end space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <button type="submit"
                    ...
                    {{ $isEdit ? 'Kemaskini Jadual' : 'Simpan Jadual' }}
                </button>
            </div>
        </form>
    </div>
