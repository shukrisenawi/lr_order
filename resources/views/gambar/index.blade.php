...
@section('title', 'Gambar Management')

@section('content')
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Gambar Management</h1>
                <p class="text-gray-600">Manage your images</p>
            </div>
            <a href="{{ route('gambar.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center">
        ...
        @forelse($gambar as $item)
            <div class="bg-white rounded-lg shadow overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-600 text-sm mb-3">{{ Str::limit($item->description ?? 'No description', 100) }}</p>
        ...
        @empty
            <div class="col-span-full">
                <div class="bg-white rounded-lg shadow p-12 text-center">
                    ...
                    <a href="{{ route('gambar.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg inline-flex items-center">
                        <i class="fas fa-plus mr-2"></i>
                        Upload Image
                    </a>
                </div>
