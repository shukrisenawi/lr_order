...
@section('content')
    <div class="mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Upload New Image</h1>
                <p class="text-gray-600">Add a new image to your gallery</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <form method="POST" action="{{ route('gambar.store') }}" enctype="multipart/form-data" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Title -->
                <div>
                    <label for="nama" class="block text-sm font-medium text-gray-700 mb-2">Nama Gambar</label>
                ...
                <div class="md:col-span-2">
                    ...
                    @error('alt_text')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-sm text-gray-500">Alternative text for accessibility</p>
                </div>
            </div>
